...
export const changelogCards: ChangelogCardInterface[] = [
    {
        ...
        time: '02:15',
        changes: [
            '[02:15] Добавлена страница документов предметов',
        ],
    },
    {
        version: '24.21.2',
    ...
    },
    {
        ...
        time: '00:45',
        changes: [
            '[00:05] Переименованы некоторые поля, добавлен тип "ПК"',
            '[00:40] Добавлено формирование артикула',
        ],
    },
    {
        version: '24.21',
        time: '01:05',
        changes: [
            '[01:05] Добавлена мобильная версия',
        ],
    },
    {
        version: '24.20',
    ...
    },
    {
        ...
        time: '00:30',
        changes: [
            '[00:30] В разделе Users добавлена кнопка для отправки карты сотрудника в почтовый ящик',
        ],
    },
    {
        version: '24.18.1',
        time: '00:05',
        changes: [
            '[00:05] Добавлена сортировка почтовых групп в левой секции',
        ],
    },
    {
        version: '24.18',
        time: '03:10',
        changes: [
            '[03:10] Добавлена новая страница с конфигурацией приложения',
        ],
    },
    {
        version: '24.17.1',
        time: '00:10',
        changes: [
            '[00:05] Расширены кнопки добавления и удаления в диалоге с группами',
            '[00:05] Сделана сортировка для почтовых групп в таблице и в диалоге',
        ],
    },
    {
        version: '24.17',
    ...
    },
    {
        ...
        time: '01:30',
        changes: [
            '[01:30] Перенесена логика генерации архива с клиента на сервер',
        ],
    },
    {
        version: '24.16.2',
